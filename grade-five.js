const questions = [
    ...
    {
        question: "We can save files on our computer and also on the ________________.",
        answers: [
            { text: "Website", correct: false},
            { text: "Internet", correct: true},
    ...
    {
        question: "I am a tag, i carry the website information. Who am I?",
        answers: [
    ...
    {
        question: "A librarian is a persaon that direct people to check books in library. What can we call virtual Librarian?",
        answers: [
    ...
    {
        question: "A library is a place where books are kept. What can we call virtual Library?",
        answers: [
            { text: "Search Engine", correct: false},
